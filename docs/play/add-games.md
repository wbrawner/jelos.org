...
If your device does not recognize your card please open `System Settings` and make sure `Autodetect Games Card` is turned on (located under the Preferences header).
